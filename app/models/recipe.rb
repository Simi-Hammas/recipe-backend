class Recipe < ApplicationRecord
  ...
  validates :preparation_time, presence: true, numericality: { only_integer: true, less_than_or_equal_to: 4 }
  validates :cooking_time, presence: true, numericality: { only_integer: true, less_than_or_equal_to: 4 }

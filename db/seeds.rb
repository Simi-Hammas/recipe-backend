...
Recipe.create(title: 'Chicken Biriyani', description: 'Made of Chicken and Rice', method: 'Coming Soon Inshallah', preparation_time: 60, cooking_time: 60, ease_of_preparation: 'Medium', notes: 'NA', photo: 'https://healux.in/wp-content/uploads/2020/11/ChickenBiryani.jpg', recipe_type: ['Non-Veg'], country: 'Pakistan', accessible: false, deleted_recipe: false, user_id: 1);

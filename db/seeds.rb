...
User.create(username:'hammas', bio:'Pakistani Chef', email:'hammas@gmail.com', password: 'hammas1234', photo:'hammas123.png', country:'Pakistan', public_name:'Pakistani Chef');
